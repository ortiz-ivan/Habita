import type { SelectHTMLAttributes, CSSProperties, ReactNode } from 'react'
...
export function FormFooter({ apiError, onCancel, isLoading, isEdit }: FormFooterProps) {
  return (
    <>
      {apiError && (
        <p
...
export function InfoCard({ label, value, colSpan, style, labelStyle, children }: InfoCardProps) {
  return (
    <div
