...
export default function TipoHabitacionForm({ defaultValues, onSubmit, onCancel, isLoading, apiError }) {
  ...
  const doSubmit = (data) => onSubmit(data, applyToAll)
      ...
      {isEdit && (
        ...
        >
          ...
          <div>
            ...
            {defaultValues?.habitaciones_count > 0 && (
